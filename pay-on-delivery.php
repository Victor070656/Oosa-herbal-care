    ...
    <main id="MainContent" class="content-for-layout">
      <div class="container checkout-page mt-100">
        <div class="card py-5 px-4" style="border-radius: 15px">
          <div class="card-body text-center">
            <h1 class=" mb-3">🚚</h1>
            <h1 class="display-5 fw-bold ">Payment on Delivery</h1>
            <h4 class="">Your order costs: ₦<?= number_format($info["amount"]); ?></h4>
            <div class="col-md-6 text-center mx-auto">

              <form method="post">

                <button type="submit" name="pay_now" class="btn btn-primary">Confirm</button>
              </form>
            </div>
          </div>
        </div>
      ...
      if (isset($_POST['pay_now'])) {
        ...
        $emailBody = '
                ...
                <html>
                  ...
                  <body>
                    ...
                    <div class="content">
                      <p>Hello there,</p>
                      <p>An Order was just placed now (Payment On Delivery) - Payment Reference: #' . $ref . '</p>
        ...
        $addOrder = mysqli_query($conn, "INSERT INTO `orders`(`orderid`, `userid`, `ref`, `payment_type`, `items`, `amount`, `firstname`, `lastname`, `email`, `phone`, `country`, `city`, `zipcode`, `address1`, `address2`) 
            VALUES ('$order_id', '$userid', '$ref', 'On Delivery', '$order_items', '$order_amount', '$order_firstname', '$order_lastname', '$order_email', '$order_phone', '$order_country', '$order_city', '$order_zip', '$order_address1', '$order_address2')");
        if ($addOrder) {
