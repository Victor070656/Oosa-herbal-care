...
<head>
    <title>Oosa Herbal Ventures || Forgot Password</title>
    <!-- meta tags -->
    <meta charset="utf-8">
                    ...
                    <form method="post" class="login-form common-form mx-auto">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mt-3 text-center">
                                <button type="submit" name="send" class="btn-primary d-block mt-4 btn-signin">SEND
                                    CODE</button>
                            </div>
                        </div>
                        <!-- login -->
                        ...
                        if (isset($_POST["send"])) {
                            ...
                            $loginUser = mysqli_query($conn, "SELECT * FROM `users` WHERE `email`='$email'");
                            if (mysqli_num_rows($loginUser) > 0) {
                                ...
                                if ($addCode) {
                                    ...
                                    if ($send) {
                                        echo "<script>location.href='code.php?e=$email'</script>";
                                    } else {
